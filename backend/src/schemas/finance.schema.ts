...
// schema for updating category (fields are optional)
...
export const upsertBudgetSchema = z.object({
    body: z.object({
        category: z.string().regex(/^[0-9a-fA-F]{24}$/, 'Invalid Category ID'), // must be valid mongo id
...
export const transactionSchema = z.object({
    body: z.object({
        ...
        description: z
            ...
            .optional()
            .default(''),
        date: z.coerce.date().optional() // if not provided, backend can handle default
    })
});