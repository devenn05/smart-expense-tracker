...
export const Login = () => {
 ...
 <div className="text-right mt-1.5"><Link to="/forgot-password" className="text-xs font-semibold text-brand-600 hover:text-brand-800">Forgot memory link?</Link></div>
                </div>
